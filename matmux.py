...
class Solution:
    def matrix_mult(self,m1, m2):
        ...
        topleft = (m1[0][0] * m2[0][0]) +(m1[0][1] * m2[1][0]) 

        topright = (m1[0][0] * m2[0][1]) +(m1[0][1] * m2[1][1]) 

        bottomright = (m1[1][0] * m2[0][1]) +(m1[1][1] * m2[1][1])

        bottomleft =  (m1[1][0] * m2[0][0]) +(m1[1][1] * m2[1][0])

        toprow = [topleft, topright]
        botrow = [bottomleft, bottomright]
